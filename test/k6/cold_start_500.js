...
// Mot de passe jamais en dur : k6 run -e LOAD_TEST_PASSWORD=... cold_start_500.js
const TEST_EMAIL    = "test.load@allofoods.bj";
const TEST_PASSWORD = __ENV.LOAD_TEST_PASSWORD;
if (!TEST_PASSWORD) {
  throw new Error("LOAD_TEST_PASSWORD manquant — lancer avec: k6 run -e LOAD_TEST_PASSWORD=xxx cold_start_500.js");
}
