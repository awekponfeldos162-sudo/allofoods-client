...
// Compte test (créer dans Firebase Console > Authentication) — mot de passe
// jamais en dur dans le script : k6 run -e LOAD_TEST_PASSWORD=... test.js
const TEST_EMAIL    = "test.load@allofoods.bj";
const TEST_PASSWORD = __ENV.LOAD_TEST_PASSWORD;
if (!TEST_PASSWORD) {
  throw new Error("LOAD_TEST_PASSWORD manquant — lancer avec: k6 run -e LOAD_TEST_PASSWORD=xxx allofoods_load_test.js");
}
